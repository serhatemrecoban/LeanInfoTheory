...
GITHUB_SOURCE_ROOT = "https://github.com/serhatemrecoban/LeanInfoTheory/blob/v0.1.0"
...
def write_json(declarations: list[Declaration]) -> None:
    JSON_OUTPUT.write_text(generated_json(declarations), encoding="utf-8")
    ...
    <main class="main-content" role="main">
      <section class="status-strip" aria-label="Generation status">
        <p>
          ...
          non-stable examples and reference anchors; the supported v0.1 API is
          the 601-declaration, 31-module surface documented in the
          <a href="v0.1.0/">signature-bearing reference</a>.
        </p>
      </section>
