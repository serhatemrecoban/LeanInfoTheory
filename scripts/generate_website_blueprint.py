...
MODULE_SUMMARIES = {
    ...
    "LeanInfoTheory.Shannon.SemanticBridge": "Aggregate entry point for finite semantic, KL, independence, Markov, and data-processing bridges.",
    ...
    "LeanInfoTheory.Shannon.SemanticBridge.DataProcessing": "Finite KL channel contraction, invariant-law consequences, and doubly stochastic entropy growth.",
