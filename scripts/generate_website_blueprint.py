...
current LeanInfoTheory module graph, and emits website artifacts. It does not
try to generate theorem-level dependencies or declaration documentation.
"""
...
<html lang="en-US">
  <head>
    ...
    <title>Generated dependency map | LeanInfoTheory</title>
    <link rel="stylesheet" href="../styles.css">
  </head>
  <body>
    <header class="page-header" role="banner">
      <h1 class="project-name">Generated Dependency Map</h1>
    ...
    <main class="main-content" role="main">
      <section class="status-strip" aria-label="Generation status">
        <p>
          ...
          local Lean <code>import</code> lines. This is a module-level map; a
