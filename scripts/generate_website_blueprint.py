...
MODULE_SUMMARIES = {
    ...
    "LeanInfoTheory.Shannon.SemanticBridge": "Aggregate entry point for finite semantic, KL, independence, Markov, sufficiency, data-processing, and recovery bridges.",
    ...
    "LeanInfoTheory.Examples": "Opt-in aggregate for certificate, support-sensitive, Markov, channel, sufficiency, and Fano examples.",
