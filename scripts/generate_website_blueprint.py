...
MODULE_SUMMARIES = {
    ...
    "LeanInfoTheory.Shannon.InfoMeasures": "Marginals, conditional entropy, mutual information, conditional mutual information, orientation lemmas, and the auxiliary-variable information decomposition.",
    ...
    "LeanInfoTheory.Shannon.SemanticBridge.Markov": "Finite Markov characterizations, channel factorization, information loss, and mutual-information data processing.",
    "LeanInfoTheory.Shannon.SemanticBridge.Sufficiency": "Fixed-prior and model-family sufficiency, common recovery, and full-support/all-prior characterizations.",
    "LeanInfoTheory.Shannon.SemanticBridge.DataProcessing": "Finite channel posteriors, supported sufficiency, KL data processing and equality, and entropy-growth consequences.",
    ...
    "LeanInfoTheory.Examples": "Non-stable aggregate for maintained conditional-KL, convexity, finite-family, independence-processing, information-decomposition, support-sensitive, Markov, channel, sufficiency, Fano, and units regression consumers.",
    ...
    "LeanInfoTheory.Examples.IndependenceProcessing": "Private arbitrary-PMF consumers for non-injective and constant independence postprocessing, infinite types, symmetry, and finite zero mutual information.",
    "LeanInfoTheory.Examples.InformationDecomposition": "Private lightweight consumers for the auxiliary-variable MI decomposition, algebraic zero terms, singleton variables, and sparse joint laws.",
